                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu">
                                            <button type="button" onclick="restoreWriter({{ $item->id }})"
...
<script>
    function forceDelete(id, refranses) {
        ...
        deleteItem('/writer/forceDelete/', id, refranses)

    }


    function restoreWriter(id) {

        axios.post('/writer/restore/' + id)
            .then(function(response) {
                success(response.data)
                window.location.href = '/writer/archive'
