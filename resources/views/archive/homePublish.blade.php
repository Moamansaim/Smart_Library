                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu">
                                            <button type="button" onclick="restorehomePublish({{ $item->id }})"
...
<script>
    function forceDelete(id, refranses) {
        ...
        deleteItem('/homePublish/forceDelete/', id, refranses)

    }


    function restorehomePublish(id) {

        axios.post('/homePublish/restore/' + id)
            .then(function(response) {
                success(response.data)
                window.location.href = '/homePublish/archive'
