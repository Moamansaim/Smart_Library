                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu">
                                            <button type="button" onclick="restoreCategory({{ $item->id }})"
...
<script>
    function forceDelete(id, refranses) {
        ...
        deleteItem('/category/forceDelete/', id, refranses)
    ...
    function restoreCategory(id) {
        ...
        axios.post('/category/restore/' + id)
            .then(function(response) {
                success(response.data)
                window.location.href = '/category/archive'
