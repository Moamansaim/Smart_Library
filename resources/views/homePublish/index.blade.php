        ...
        <div class="card">
            ...
            <div class="navbar-nav align-items-center">
                <div class="nav-item d-flex align-items-center">
                    <form action="{{ route('index.homePublish') }}" class="d-flex mt-3"
            ...
            <h5 class="card-header">{{ __('Home Publish') }}</h5>
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu">
                                            <a class="dropdown-item" href="{{ route('edit.homePublish', $item->id) }}"><i
                                                    class="bx bx-edit-alt me-2"></i>{{ __('Edit') }} </a>
                                            <button type="button" onclick="deleteHome({{ $item->id }},this)"
...
<script>
    function deleteHome(id, refranses) {
        deleteItem('/homePublish/destroy/', id, refranses)
    }
